...
def render_home_page():
    if request.method == 'POST':
        ...
        cursor.execute(
            "INSERT INTO your_table_name (first_name, last_name, email, address, zip_code, phone_number, city) "
...
def render_history_page():
    if request.method == 'POST':
        return redirect(url_for('history_page'))  # Redirect to the 'history_page' route
